 ...
 */
     ...
     */
         ...
         *
         *
         * @see \App\Providers\RouteMacroServiceProvider::boot()
         * @static
         */
        public static function getGroupName()
        {
                        return \Illuminate\Routing\Router::getGroupName();
        }
                    /**
         *
         *
         ...
         * @static
         */
        public static function groupName($groupName)
        {
                        return \Illuminate\Routing\Router::groupName($groupName);
        }
