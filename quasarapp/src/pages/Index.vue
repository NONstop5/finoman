  ...
  <q-page class="fit row wrap justify-center items-center content-start">
    ...
    >
      <q-card-section>
        ...
        <div class="text-subtitle2">{{card.balanse}}</div>
      </q-card-section>
    </q-card>
    ...
    <div class="flex items-center q-mt-xl">
      ...
      <q-btn round outline color="secondary">
      <q-icon
            name="fas fa-plus"
            :size="'1.5em'"
        />
    ...
    >
      <q-item>
        <q-item-section avatar>
          <q-avatar>
            <q-icon v-if="transaction.spending"
      ...
      <q-item>
        <q-item-label v-if="transaction.spending" class="q-pt-sm">-{{transaction.price}} ₽</q-item-label>
        <q-item-label  v-else class="q-pt-sm text-positive">+{{transaction.price}} ₽</q-item-label>
      </q-item>
    </q-card>
    </div>
    <q-btn
